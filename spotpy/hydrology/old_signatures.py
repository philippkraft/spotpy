# -*- coding: utf-8 -*-
"""
Copyright (c) 2018 by Tobias Houska and Justus Liebig University Giessen
This file is part of Statistical Parameter Optimization Tool for Python (SPOTPY).
:author: Philipp Kraft, Benni Manns

This file is temporary and contains the "old" hydrology as written by Benni in the first attempt

Delete each method that is refactored into scalar_signatures or vector_signatures. Delete this module when done
"""
...
def __calcFlowLevelEventFrequency(data, datetime_series, threshold_value, flow_level_type):
    ...
    See paper "Uncertainty in hydrological hydrology" by I. K. Westerberg and H. K. McMillan, Hydrol. Earth Syst. Sci.,
